...
const Stats = () => {
    return (
        <div className='relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-red-200 to-red-500"'>
            <section classNameName="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Products Stats!</h1>
